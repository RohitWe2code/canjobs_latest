...
--
-- Host: localhost:3306
-- Generation Time: Jun 06, 2023 at 02:03 PM
...
(21, 'Annu', 'aashi.we2code@gmail.com', '4f1058b235cc3827fb8888a5d1aab930', 2587410369, NULL, '2000-01-01', 'male', 'single', 'indian', 'india', 'India', 'English', NULL, 'parttime', '1-3 ', 'no', 'India', 0, 0, '0000-00-00', '', 'https://apnaorganicstore.in/canjobs/uploads/1685947564.pdf', NULL, '2023-06-05 06:46:04', 1, '2023-06-06 04:46:23', 1, '587ea74f1e1c1b667fcfa0826f5ac338', '', '', ''),
(22, 'Annu', 'aashi.we2code@gmail.com', '4f1058b235cc3827fb8888a5d1aab930', 8745213690, 'hello', '1999-07-13', 'female', 'single', 'indian', 'india', 'India', 'English', NULL, 'swap', '1-3 ', 'no', 'India', 0, 0, '0000-00-00', '', 'https://apnaorganicstore.in/canjobs/uploads/1685948833.pdf', 'https://apnaorganicstore.in/canjobs/uploads/1685948823.jpeg', '2023-06-05 07:03:07', 0, '2023-06-06 04:46:23', 0, '587ea74f1e1c1b667fcfa0826f5ac338', '', '', '');
...
(7, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Aashi Vyas', 'aashi.we2code@gmail.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'https://lh3.googleusercontent.com/a/AAcHTteF1y7ML3nJ3laAgbbpdifExtG5L29jwxR_DBzg=s96-c', 0, '2023-06-03 09:04:54', '2023-06-05 07:07:38', 0, 0, '', '587ea74f1e1c1b667fcfa0826f5ac338', '107979113144063469587', '', ''),
(8, 'Mayur industries ', 'Information Technology', 'B2C', 'myi', NULL, '15', 'www.mayurindustries.com', 'Developers', 'company oversees the use of devices storing, retrieving, and sending information.', 'Mayur yadav', 'g.choudhary.we2code@gmail.com', '167b5b0d9cd1650a147abb3d41dba85d', 9874563210, NULL, 'Ram nagar', 752963, 'indore', 'mp', 'India', 'CEO', 'https://apnaorganicstore.in/canjobs/uploads/1685949888.jpeg', 0, '2023-06-05 07:16:03', '2023-06-05 07:30:33', 0, 0, 'Indore', '', '', '', '');
...
(14, 4, 8, 'Approved', '2023-06-06', 1, '2023-06-06 04:26:17', '2023-06-06 04:26:17'),
(15, 7, 5, 'Draft', '2023-06-10', 1, '2023-06-06 07:03:48', '2023-06-06 07:05:33');
...
--
ALTER TABLE `admin`
  MODIFY `admin_id` int(101) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `apply_on_job`
--
ALTER TABLE `apply_on_job`
  MODIFY `apply_id` int(101) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
...
--
ALTER TABLE `email`
  MODIFY `id` int(101) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
...
--
ALTER TABLE `employee`
  MODIFY `employee_id` int(101) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;
...
--
ALTER TABLE `follow_up`
  MODIFY `id` int(101) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=453;

--
-- AUTO_INCREMENT for table `jobs`
--
ALTER TABLE `jobs`
  MODIFY `job_id` int(101) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `job_interviews`
  MODIFY `id` int(51) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=52;
...
--
ALTER TABLE `notification`
  MODIFY `id` int(101) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=301;
